...
[`derive_vars_cat()`](https:/pharmaverse.github.io/admiral/v1.5.0/cran-release/reference/derive_vars_cat.html)
...
| ADaM   | Sample Code                                            |
|--------|--------------------------------------------------------|
| ADBCVA | `use_ad_template("adbcva", package = "admiralophtha")` |
