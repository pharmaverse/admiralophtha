...
- The following functions are entering the next phase of the
  ...
  **Phase 2 (warning)**
  ...
  - [`derive_var_bcvacritxfl()`](https:/pharmaverse.github.io/admiralophtha/297_add_explore_adam_templastes_article@main/dev/reference/derive_var_bcvacritxfl.md)
    and its internal utility function
    [`derive_var_bcvacritxfl_util()`](https:/pharmaverse.github.io/admiralophtha/297_add_explore_adam_templastes_article@main/dev/reference/derive_var_bcvacritxfl_util.md).
...
- Updated to [roxygen2](https://roxygen2.r-lib.org/) 8.0.0.
  ([\#301](https://github.com/pharmaverse/admiralophtha/issues/301))
...
- Started using custom [admiral](https://pharmaverse.github.io/admiral/)
  roclet, resulting in cleared “Permitted” and “Default” values in
  function documentation.
  ([\#277](https://github.com/pharmaverse/admiralophtha/issues/277))

- Removed erroneous deprecation badges for `dataset` and `loc_vals`
  arguments of
  [`derive_var_afeye()`](https:/pharmaverse.github.io/admiralophtha/297_add_explore_adam_templastes_article@main/dev/reference/derive_var_afeye.md).
  ([\#278](https://github.com/pharmaverse/admiralophtha/issues/278))
...
- Updated ADOE template to showcase the mapping of IOP parameters, as
  well as the derivation of parameters for the difference between pre
  and post-dose IOP.
  ([\#260](https://github.com/pharmaverse/admiralophtha/issues/260))

- Added a citation for the source of the Visual Functioning
  Questionnaire (VFQ) to the ADVFQ template, vignette and test dataset
  documentation.
  ([\#243](https://github.com/pharmaverse/admiralophtha/issues/243))

### Various

- Removed [cli](https://cli.r-lib.org) from package imports.
  ([\#264](https://github.com/pharmaverse/admiralophtha/issues/264))
...
- The following function arguments of
  [`derive_var_afeye()`](https:/pharmaverse.github.io/admiralophtha/297_add_explore_adam_templastes_article@main/dev/reference/derive_var_afeye.md)
  are removed following the end of their deprecation cycle
  ([\#237](https://github.com/pharmaverse/admiralophtha/issues/237)):
...
- The following function arguments of
  [`derive_var_afeye()`](https:/pharmaverse.github.io/admiralophtha/297_add_explore_adam_templastes_article@main/dev/reference/derive_var_afeye.md)
  are entering the next (and final) phase of the deprecation process
  ([\#223](https://github.com/pharmaverse/admiralophtha/issues/223)):
...
- All vignettes and templates in
  [admiralophtha](https://pharmaverse.github.io/admiralophtha/) have
  been updated to use the
  [admiral](https://pharmaverse.github.io/admiral/) subject keys option
...
- [`derive_var_afeye()`](https:/pharmaverse.github.io/admiralophtha/297_add_explore_adam_templastes_article@main/dev/reference/derive_var_afeye.md)
  was updated
  ([\#214](https://github.com/pharmaverse/admiralophtha/issues/214)):

  - A bug was removed where the function issued warnings when missing
    `xxLOC` values were present in the input dataset.
  - The argument `dataset_occ` was deprecated in favor of `dataset`, in
    line with [admiral](https://pharmaverse.github.io/admiral/)
    conventions.
  - The argument `lat_vals` was deprecated. Laterality values are now
    just expected to be “LEFT”, “RIGHT” or “BILATERAL”.
...
- Added a new parameter `crit_var` to
  [`derive_var_bcvacritxfl()`](https:/pharmaverse.github.io/admiralophtha/297_add_explore_adam_templastes_article@main/dev/reference/derive_var_bcvacritxfl.md)
...
- Switched out `derive_var_merged_cat()` for
  ...
  in the function
  [`derive_var_studyeye()`](https:/pharmaverse.github.io/admiralophtha/297_add_explore_adam_templastes_article@main/dev/reference/derive_var_studyeye.md)
...
- Added a reference for the ETDRS to LogMAR conversion done by
  [`convert_etdrs_to_logmar()`](https:/pharmaverse.github.io/admiralophtha/297_add_explore_adam_templastes_article@main/dev/reference/convert_etdrs_to_logmar.md)
  and
  [`convert_logmar_to_etdrs()`](https:/pharmaverse.github.io/admiralophtha/297_add_explore_adam_templastes_article@main/dev/reference/convert_logmar_to_etdrs.md)
