...
- The following functions are entering the next phase of the
  ...
  **Phase 1 (message)**
  ...
  - [`derive_var_bcvacritxfl()`](https:/pharmaverse.github.io/admiralophtha/295_pr_website/reference/derive_var_bcvacritxfl.md)
    and its internal utility function
    [`derive_var_bcvacritxfl_util()`](https:/pharmaverse.github.io/admiralophtha/295_pr_website/reference/derive_var_bcvacritxfl_util.md).
...
- Removed erroneous deprecation badges for `dataset` and `loc_vals`
  arguments of
  [`derive_var_afeye()`](https:/pharmaverse.github.io/admiralophtha/295_pr_website/reference/derive_var_afeye.md).
...
- Switched out `derive_var_merged_cat()` for
  ...
  in the function
  [`derive_var_studyeye()`](https:/pharmaverse.github.io/admiralophtha/295_pr_website/reference/derive_var_studyeye.md)
...
- Added a reference for the ETDRS to LogMAR conversion done by
  [`convert_etdrs_to_logmar()`](https:/pharmaverse.github.io/admiralophtha/295_pr_website/reference/convert_etdrs_to_logmar.md)
  and
  [`convert_logmar_to_etdrs()`](https:/pharmaverse.github.io/admiralophtha/295_pr_website/reference/convert_logmar_to_etdrs.md)
