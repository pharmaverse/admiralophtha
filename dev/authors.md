...
- **Ritika Aggarwal**. Author.

- **Jane Gao**. Author.

- **William Holmes**. Author.

- **Josie Jackson**. Author.

- **Sonali Jain**. Author.

- **Yuki Matsunaga**. Author.

- **Gordon Miller**. Author.

- **Rachel Linacre**. Author.

- **Lucy Palmen**. Author.

- **Nandini R Thampi**. Author.

- **Aldrich Salva**. Author.
...
- **[](https://www.novartis.com/)[![Novartis
  logo](reference/figures/novartis_logo.png)](https://www.gsk.com/)**.
  Copyright holder, funder.
...
version 1.3.0.9005, <https://pharmaverse.github.io/admiralophtha/>.
    ...
    @Manual{,
      ...
      year = {2025},
      note = {R package version 1.3.0.9005},
