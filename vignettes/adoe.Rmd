...
The user is invited to consult the article on [creating a BDS dataset from SDTM](https://pharmaverse.github.io/admiral/articles/cran-release/bds_finding.html) to learn how to add standard BDS variables to ADOE. 
