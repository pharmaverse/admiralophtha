...
* [Define Parameters in lookup table](#parameters)
...
## Derive Parameters in lookup table {#parameters}
 
Create a parameter look up table which includes `QSTESTCD`, `PARAMCD`, `PARAM`, `PARCAT1` and `PARCAT2`.
...
It adds one parameter to the input dataset with one observation per -->
